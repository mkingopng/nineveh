...
if __name__ == '__main__':
    ...
    st.write(
        'This app is meant to improve the quality of your CV by using '
        'Artificial Intelligence\n Start by downloading the template, fill '
        'the information, upload your CV and enjoy the magic! :smile:')
    st.write(
        "\n Let's see what you got! Download the following template and fill "
        "it out with your information! :sunglasses:")
    download_template()
    ...
    if uploaded_file is not None:
        ...
        st.write('We noticed that you added ' + str(
            len(experience_parser(string_data))) + ' work experiences! :eyes:')
