...
ORDERED_KEYS = ['NAME', 'DOB', 'WORKING AS', 'SUMMARY', 'EXPERIENCE', 'SCHOOL',
                'CONTACTS']
DOB_PROMPT = ('Check that the following date is in YYYY/MM/DD. Correct it if '
              'its not in the same format, otherwise return the same:')
